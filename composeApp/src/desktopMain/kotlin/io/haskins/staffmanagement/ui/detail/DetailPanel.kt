...
import io.haskins.staffmanagement.ui.detail.departments.departmentPanel
import io.haskins.staffmanagement.ui.detail.employees.employeePanel
import io.haskins.staffmanagement.ui.detail.managers.managerPanel
...
fun detailPanel(currentDetail: MutableState<ListItem>) {
    ...
    Box(Modifier.layoutId("second")) {
        ...
        when(currentDetail.value.type) {
            ...
            FilterType.Departments.id -> departmentPanel()
